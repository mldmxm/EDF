...
if __name__ == "__main__":
    ...
    for people in os.listdir(r"./data_leaveone_all/CASME/"):
        for spiltdata in os.listdir(r"./data_leaveone_all/CASME/" + people + '/'):
            for pic_class in os.listdir(r"./data_leaveone_all/CASME/" + people + '/' + spiltdata + '/'):
                for pic in os.listdir(r"./data_leaveone_all/CASME/" + people + '/' + spiltdata + '/' + pic_class):
                    img = cv2.imread(
                        './data_leaveone_all/CASME/' + people + '/' + spiltdata + '/' + pic_class + '/' + pic)
        ...
        # print('old dataset shape %s', Counter(Y_train_temp))
