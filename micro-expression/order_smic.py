...
def re_sample(X_train_temp, Y_train_temp):
    ...
    df_c1_sample = df_1.sample(n=num_1_0, replace=True, random_state=1)
    df_c2_sample = df_2.sample(n=num_2_0, replace=True, random_state=1)
...
if __name__ == "__main__":
    ...
    for _, one in enumerate(people):
        ...
        #         ei_5.append(1)
        # dataname = 'SMIC.csv'
        # result = pd.DataFrame({'y_true': y_true, 'ei_0': ei_0, 'ei_1': ei_1, 'ei_2': ei_2, 'ei_3': ei_3, 'ei_4': ei_4, 'ei_5': ei_5})
