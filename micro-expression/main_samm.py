...
if __name__ == "__main__":
    ...
    for people in os.listdir(r"./data_leaveone_all/SAMM"):
        print(people)
        for spiltdata in os.listdir(r"./data_leaveone_all/SAMM/" + people + '/'):
            for pic_class in os.listdir(r"./data_leaveone_all/SAMM/" + people + '/' + spiltdata + '/'):
                for pic in os.listdir(r"./data_leaveone_all/SAMM/" + people + '/' + spiltdata + '/' + pic_class):
                    img = cv2.imread(
                        './data_leaveone_all/SAMM/' + people + '/' + spiltdata + '/' + pic_class + '/' + pic)
